...
- Adicionar cache Caffeine aos endpoints de relatorios (`/reports/summary`, `/reports/by-category`, `/reports/evolution`, `/reports/estimate`) — adiado para sprint futura.
