...
A partir da issue #29 o build aplica o plugin JaCoCo: `./mvnw test` gera o relatorio em `target/site/jacoco/` e `./mvnw verify` aplica o gate de **>= 70% de cobertura por instrucao no pacote `com.goodfunds.service`** (atualmente acima de 90%). Falhar essa regra quebra o build.
